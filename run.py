...
def get_sales_data():
    ...
    the terminal, which must be a string of 6 numbers seperated by
...
def calculate_surplus_data(sales_row):
    ...
    The surplus is defined as the sales figure subtracted from the week:
    - Positive surplus indicates waste.
    - Negative surplus indicates extra made when stcok was sold out.
    """
